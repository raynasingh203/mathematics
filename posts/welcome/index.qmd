...
Honestly, I never thought using CSVs to store hand landmarks would actually work for training a neural network. I always thought of CSVs for supervised learning as basic ML stuff, independent and dependent variables, the usual. So this approach definitely had me confused at first. But once I got into the code, it all started to click. Not everything went smoothly, but figuring things out along the way made it way more rewarding.
